...
class AnswerModelAdmin(admin.ModelAdmin):
	...
	list_display = ["rating", "comment", "date_added"]	# какие колонки будут в админке для данной модели
	list_display_links = ["rating", "date_added"]	# на каких колонках будут ссылки
	list_filter = ["rating", "date_added"]	# какие колонки доступны для сортировки
